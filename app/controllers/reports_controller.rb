...
#    @report = Report.new(report_params)
  ...
  private
    ...
    def report_params
      params.require(:report).permit(:user_id, :teacher, :teacher_comment, :principal, :principal_comment, :student_id, :term_id, results_attributes: [:id, :user_id, :classmark, :testmark, :subject_id, :comment , :_destroy])
    end
end
