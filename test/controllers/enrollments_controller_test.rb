...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { schoolyear_id: @enrollment.schoolyear_id, student_id: @enrollment.student_id, subject_id: @enrollment.subject_id }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { schoolyear_id: @enrollment.schoolyear_id, student_id: @enrollment.student_id, subject_id: @enrollment.subject_id }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
